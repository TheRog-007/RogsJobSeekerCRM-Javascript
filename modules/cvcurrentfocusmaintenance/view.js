...
// intSize = modSchema.funcGetFieldSize("CV_CurrentFocus", "CVF_Details");
...
//   modModel.txtCVF_Details.style.marginTop = "10px";
//   modModel.txtCVF_Details.style.width = "228px";
//   modModel.txtCVF_Details.attributes.required = true;
//   modModel.txtCVF_Details.setAttribute(
//     "maxLength",
//     modSchema.funcGetFieldSize("CV_CurrentFocus", "CVF_Details")
//   );
...
*/
  ...
  objData.onsuccess = () => {
    ...
    //load data!
    modModel.txtCVF_Details.value = objFound.CVF_Details;
    //store in objTable in order they are in schema
    modModel.objTable.aryFields[0].fieldValue = modModel.cmbID.value;
    modModel.objTable.aryFields[1].fieldValue = objFound.CVF_Details;
    //reset new indicator
