...
export const dteCVED_YearStarted = document.getElementById(
  "dteCVED_YearStarted"
);
export const lblCVED_YearStarted = document.getElementById(
  "lblCVED_YearStarted"
);
export const dteCVED_YearEnded = document.getElementById("dteCVED_YearEnded");
export const lblCVED_YearEnded = document.getElementById("lblCVED_YearEnded");
export const txtCVED_Where = document.getElementById("txtCVED_Where");
export const lblCVED_Where = document.getElementById("lblCVED_Where");
export const txtCVED_What = document.getElementById("txtCVED_What");
export const lblCVED_What = document.getElementById("lblCVED_What");
export const txtCVED_Grade = document.getElementById("txtCVED_Grade");
export const lblCVED_Grade = document.getElementById("lblCVED_Grade");
  ...
  function funcCreateItems() {
    ...
    qryTemp.onsuccess = (event) => {
      ...
      if (curTemp) {
        ...
        elTemp.innerText = curTemp.value.CVED_What;
...
*/
  ...
  const objTemp = dbRequest.objectStore(modSchema.constCV_Education);

  if (blnNew) {
    dbUpdate = objTemp.add({
      CVED_YearStarted: dteCVED_YearStarted.value,
      CVED_YearEnded: dteCVED_YearEnded.value,
      CVED_Where: txtCVED_Where.value,
      CVED_What: txtCVED_What.value,
      CVED_Grade: txtCVED_Grade.value,
    });
    ...
    dbQuery.onsuccess = () => {
      ...
      //edit
      dbData.CVED_YearStarted = dteCVED_YearStarted.value;
      dbData.CVED_YearEnded = dteCVED_YearEnded.value;
      dbData.CVED_Where = txtCVED_Where.value;
      dbData.CVED_What = txtCVED_What.value;
      dbData.CVED_Grade = txtCVED_Grade.value;
      //update
...
// let objTemp = modSchema.funcGetFirstRecord(constCV_Education);
...
*/
  ...
  if (blnNew) {
    ...
    dteCVED_YearStarted.value = objTable.aryFields[1].fieldValue;
    dteCVED_YearEnded.value = objTable.aryFields[2].fieldValue;
    txtCVED_Where.value = objTable.aryFields[3].fieldValue;
    txtCVED_What.value = objTable.aryFields[4].fieldValue;
    txtCVED_Grade.value = objTable.aryFields[5].fieldValue;
  }
}
...
*/
  ...
  dteCVED_YearStarted.value = "";
  dteCVED_YearEnded.value = "";
  txtCVED_Where.value = "";
  txtCVED_What.value = "";
  txtCVED_Grade.value = "";
  dteCVED_YearStarted.focus();
};
...
*/
  ...
  if (blnNew && dteCVED_YearEnded.value.length !== 0) {
    modMessageBox.funcMessageBox(
      "Record Not Saved, Save?",
      modMessageBox.objIcons.exclamation,
      modMessageBox.objButtons.yes,
...
export function funcInitSchema() {
  //get schema
  objTable = modSchema.funcGetSchema(modSchema.constCV_Education);
}
 ...
 */
  ...
  // //get first record
  // objData = modSchema.funcGetFirstRecord(modSchema.constCV_Education);
}
export function funcInitHandlers() {
  ...
  */
  ...
  txtCVED_Grade.addEventListener("keydown", functextboxKeyDown);
  txtCVED_What.addEventListener("keydown", functextboxKeyDown);
  txtCVED_Where.addEventListener("keydown", functextboxKeyDown);
  dteCVED_YearEnded.addEventListener("keydown", functextboxKeyDown);
  dteCVED_YearStarted.addEventListener("keydown", functextboxKeyDown);
