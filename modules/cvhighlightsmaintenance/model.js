...
export const txtCVH_Details = document.getElementById("txtCVH_Details");
export const lblCVH_Details = document.getElementById("lblCVH_Details");
export const txtCVH_Name = document.getElementById("txtCVH_Name");
export const lblCVH_Name = document.getElementById("lblCVH_Name");
...
export function funcPopulateCombobox() {
  ...
  */
  ...
  function funcCreateItems() {
    ...
    const objTemp = trnTemp.objectStore(modSchema.constCV_Highlights);
...
*/
  ...
  const objTemp = dbRequest.objectStore(modSchema.constCV_Highlights);

  if (blnNew) {
    dbUpdate = objTemp.add({
      CVH_Name: txtCVH_Name.value,
      CVH_Details: txtCVH_Details.value,
    });
    ...
    dbQuery.onsuccess = () => {
      ...
      //edit
      dbData.CVH_Details = txtCVH_Details.value;
...
*/
  ...
  if (blnNew) {
    ...
    txtCVH_Name.value = objTable.aryFields[1].fieldValue;
    txtCVH_Details.value = objTable.aryFields[2].fieldValue;
  }
}
...
*/
  ...
  txtCVH_Details.value = "";
  txtCVH_Name.value = "";
  txtCVH_Details.focus();
};
...
*/
  ...
  if (blnNew && txtCVH_Details.value.length !== 0) {
    modMessageBox.funcMessageBox(
      "Record Not Saved, Save?",
      modMessageBox.objIcons.exclamation,
      modMessageBox.objButtons.yes,
...
export function funcInitSchema() {
  //get schema
  objTable = modSchema.funcGetSchema(modSchema.constCV_Highlights);
}
 ...
 */
  ...
  // //get first record
  // objData = modSchema.funcGetFirstRecord(modSchema.constCV_Highlights);
}
export function funcInitHandlers() {
  ...
  */
  ...
  txtCVH_Details.addEventListener("keydown", functextboxKeyDown);
  txtCVH_Name.addEventListener("keydown", functextboxKeyDown);
