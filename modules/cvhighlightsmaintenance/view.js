...
// intSize = modSchema.funcGetFieldSize("CV_Highlights", "CVH_Details");
...
//   modModel.txtCVH_Details.style.marginTop = "10px";
//   modModel.txtCVH_Details.style.width = "228px";
//   modModel.txtCVH_Details.attributes.required = true;
//   modModel.txtCVH_Details.setAttribute(
//     "maxLength",
//     modSchema.funcGetFieldSize("CV_Highlights", "CVH_Details")
//   );
...
*/
  ...
  objData.onsuccess = () => {
    ...
    //load data!
    modModel.txtCVH_Name.value = objFound.CVH_Name;
    modModel.txtCVH_Details.value = objFound.CVH_Details;

    //store in objTable in order they are in schema
    modModel.objTable.aryFields[0].fieldValue = modModel.cmbID.value;
    modModel.objTable.aryFields[1].fieldValue = objFound.CVH_Name;
    modModel.objTable.aryFields[2].fieldValue = objFound.CVH_Details;
    //reset new indicator
