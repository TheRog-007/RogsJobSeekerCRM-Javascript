...
export const txtCVI_Details = document.getElementById("txtCVI_Details");
export const lblCVI_Details = document.getElementById("lblCVI_Details");
export const txtCVI_Name = document.getElementById("txtCVI_Name");
export const lblCVI_Name = document.getElementById("lblCVI_Name");
...
export function funcPopulateCombobox() {
  ...
  */
  ...
  function funcCreateItems() {
    ...
    const objTemp = trnTemp.objectStore(modSchema.constCV_Interests);
    ...
    qryTemp.onsuccess = (event) => {
      ...
      if (curTemp) {
        ...
        elTemp.innerText = curTemp.value.CVI_Name;
...
*/
  ...
  const objTemp = dbRequest.objectStore(modSchema.constCV_Interests);

  if (blnNew) {
    dbUpdate = objTemp.add({
      CVI_Name: txtCVI_Name.value,
      CVI_Details: txtCVI_Details.value,
    });
    ...
    dbQuery.onsuccess = () => {
      ...
      //edit
      dbData.CVI_Details = txtCVI_Details.value;
...
// let objTemp = modSchema.funcGetFirstRecord(constCV_Interests);
...
*/
  ...
  if (blnNew) {
    ...
    txtCVI_Name.value = objTable.aryFields[1].fieldValue;
    txtCVI_Details.value = objTable.aryFields[2].fieldValue;
  }
}
...
*/
  ...
  txtCVI_Details.value = "";
  txtCVI_Name.value = "";
  txtCVI_Details.focus();
};
...
*/
  ...
  if (blnNew && txtCVI_Details.value.length !== 0) {
    modMessageBox.funcMessageBox(
      "Record Not Saved, Save?",
      modMessageBox.objIcons.exclamation,
      modMessageBox.objButtons.yes,
...
export function funcInitSchema() {
  //get schema
  objTable = modSchema.funcGetSchema(modSchema.constCV_Interests);
}
 ...
 */
  ...
  // //get first record
  // objData = modSchema.funcGetFirstRecord(modSchema.constCV_Interests);
}
export function funcInitHandlers() {
  ...
  */
  ...
  txtCVI_Details.addEventListener("keydown", functextboxKeyDown);
  txtCVI_Name.addEventListener("keydown", functextboxKeyDown);
