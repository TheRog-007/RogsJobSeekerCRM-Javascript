...
// intSize = modSchema.funcGetFieldSize("CV_Interests", "CVI_Details");
...
//     "maxLength",
//     modSchema.funcGetFieldSize("CV_Interests", "CVI_Details")
//   );
...
*/
  ...
  objData.onsuccess = () => {
    ...
    //load data!
    modModel.txtCVI_Name.value = objFound.CVI_Name;
    modModel.txtCVI_Details.value = objFound.CVI_Details;

    //store in objTable in order they are in schema
    modModel.objTable.aryFields[0].fieldValue = modModel.cmbID.value;
    modModel.objTable.aryFields[1].fieldValue = objFound.CVI_Name;
    modModel.objTable.aryFields[2].fieldValue = objFound.CVI_Details;
    //reset new indicator
