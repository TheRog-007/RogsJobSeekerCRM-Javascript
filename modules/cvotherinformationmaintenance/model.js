...
export const txtCVO_Details = document.getElementById("txtCVO_Details");
export const lblCVO_Details = document.getElementById("lblCVO_Details");
export const txtCVO_Name = document.getElementById("txtCVO_Name");
export const lblCVO_Name = document.getElementById("lblCVO_Name");
export const txtCVO_WebLink = document.getElementById("txtCVO_WebLink");
export const lblCVO_WebLink = document.getElementById("lblCVO_WebLink");
...
export function funcPopulateCombobox() {
  ...
  */
  ...
  function funcCreateItems() {
    ...
    const objTemp = trnTemp.objectStore(modSchema.constCV_Other);
    ...
    qryTemp.onsuccess = (event) => {
      ...
      if (curTemp) {
        ...
        elTemp.innerText = curTemp.value.CVO_Name;
...
*/
  ...
  const objTemp = dbRequest.objectStore(modSchema.constCV_Other);

  if (blnNew) {
    dbUpdate = objTemp.add({
      CVO_Name: txtCVO_Name.value,
      CVO_Details: txtCVO_Details.value,
      CVO_WebLink: txtCVO_WebLink.value,
    });
    ...
    dbQuery.onsuccess = () => {
      ...
      //edit
      dbData.CVO_Name = txtCVO_Name.value;
      dbData.CVO_Details = txtCVO_Details.value;
      dbData.CVO_WebLink = txtCVO_WebLink.value;
...
// let objTemp = modSchema.funcGetFirstRecord(constCV_Other);
...
*/
  ...
  if (blnNew) {
    ...
    txtCVO_Name.value = objTable.aryFields[1].fieldValue;
    txtCVO_Details.value = objTable.aryFields[2].fieldValue;
    txtCVO_WebLink.value = objTable.aryFields[3].fieldValue;
  }
}
...
*/
  ...
  txtCVO_Details.value = "";
  txtCVO_Name.value = "";
  txtCVO_WebLink.value = "";
  txtCVO_Name.focus();
};
...
*/
  ...
  if (blnNew && txtCVO_Details.value.length !== 0) {
    modMessageBox.funcMessageBox(
      "Record Not Saved, Save?",
      modMessageBox.objIcons.exclamation,
      modMessageBox.objButtons.yes,
...
export function funcInitSchema() {
  //get schema
  objTable = modSchema.funcGetSchema(modSchema.constCV_Other);
}
 ...
 */
  ...
  // //get first record
  // objData = modSchema.funcGetFirstRecord(modSchema.constCV_Other);
}
export function funcInitHandlers() {
  ...
  */
  ...
  txtCVO_Details.addEventListener("keydown", functextboxKeyDown);
  txtCVO_Name.addEventListener("keydown", functextboxKeyDown);
  txtCVO_WebLink.addEventListener("keydown", functextboxKeyDown);
