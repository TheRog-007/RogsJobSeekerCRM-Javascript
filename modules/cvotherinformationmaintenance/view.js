...
// intSize = modSchema.funcGetFieldSize("CV_Other", "CVO_Details");
...
//   modModel.txtCVO_Details.style.marginTop = "10px";
//   modModel.txtCVO_Details.style.width = "228px";
//   modModel.txtCVO_Details.attributes.required = true;
//   modModel.txtCVO_Details.setAttribute(
//     "maxLength",
//     modSchema.funcGetFieldSize("CV_Other", "CVO_Details")
//   );
...
*/
  ...
  objData.onsuccess = () => {
    ...
    //load data!
    modModel.txtCVO_Name.value = objFound.CVO_Name;
    modModel.txtCVO_Details.value = objFound.CVO_Details;
    modModel.txtCVO_WebLink.value = objFound.CVO_WebLink;

    //store in objTable in order they are in schema
    modModel.objTable.aryFields[0].fieldValue = modModel.cmbID.value;
    modModel.objTable.aryFields[1].fieldValue = objFound.CVO_Name;
    modModel.objTable.aryFields[2].fieldValue = objFound.CVO_Details;
    modModel.objTable.aryFields[3].fieldValue = objFound.CVO_WebLink;
    //reset new indicator
