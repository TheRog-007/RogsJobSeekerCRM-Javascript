...
// intSize = modSchema.funcGetFieldSize("Seekers_Status", "STA_Status");
...
//   modModel.txtSTA_Status.style.marginTop = "10px";
//   modModel.txtSTA_Status.style.width = "228px";
//   modModel.txtSTA_Status.attributes.required = true;
//   modModel.txtSTA_Status.setAttribute(
//     "maxLength",
//     modSchema.funcGetFieldSize("Seekers_Status", "STA_Status")
//   );
...
*/
  ...
  objData.onsuccess = () => {
    ...
    //load data!
    modModel.txtSTA_Status.value = objFound.STA_Status;
    //store in objTable in order they are in schema
    modModel.objTable.aryFields[0].fieldValue = modModel.cmbID.value;
    modModel.objTable.aryFields[1].fieldValue = objFound.STA_Status;
    //reset new indicator
